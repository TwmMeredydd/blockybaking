...
package dev.bitnet.blockybaking;

import dev.bitnet.blockybaking.client.ModClientSetup;
import dev.bitnet.blockybaking.init.*;
...
@Mod(BlockyBaking.MODID)
public class BlockyBaking {

    private static final Logger LOGGER = LogManager.getLogger();

    public static final String MODID = "blockybaking";

    public BlockyBaking() {
        FMLJavaModLoadingContext.get().getModEventBus().addListener(ModSetup::init);
        FMLJavaModLoadingContext.get().getModEventBus().addListener(this::enqueueIMC);
        FMLJavaModLoadingContext.get().getModEventBus().addListener(this::processIMC);
        FMLJavaModLoadingContext.get().getModEventBus().addListener(ModClientSetup::init);
